...
//    RCC_AHB3PeriphClockCmd(RCC_AHB3Periph_FSMC, ENABLE);	//ʹ��FSMCʱ��
    ...
    GPIO_InitStructure.Pin = GPIO_PIN_1;	// PB1 push-pull output, control backlight
    GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_HIGH;	//100MHz
    GPIO_InitStructure.Pull = GPIO_PULLUP;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStructure);

    GPIO_InitStructure.Pin = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_7 | GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15;//PD0,1,4,5,8,9,10,14,15 AF OUT
    ...
    GPIO_InitStructure.Pin = GPIO_PIN_7 | GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15;	//PE7~15,AF OUT
    GPIO_InitStructure.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStructure.Pull = GPIO_PULLUP;
    GPIO_InitStructure.Alternate = GPIO_AF12_FSMC;
    ...
    GPIO_InitStructure.Pin = CS_PIN;	//PF12,FSMC_A18
    GPIO_InitStructure.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStructure.Pull = GPIO_PULLUP;
    GPIO_InitStructure.Alternate = GPIO_AF12_FSMC;
...
//  GPIO_PinAFConfig(GPIOG,GPIO_PinSource12,GPIO_AF_FSMC);
    ...
    readWriteTiming.AddressSetupTime = 0XF;	 //HCLK 1/168M=6ns*16=96ns
    readWriteTiming.AddressHoldTime = 0x00;
    readWriteTiming.DataSetupTime = 60;			//HCLK	=6*60=360ns
    ...
    writeTiming.AddressSetupTime = 2;	  //12ns
    writeTiming.AddressHoldTime = 0x00;
    writeTiming.DataSetupTime = 6;		 //HCLK=102ns
    ...
    FSMC_NORSRAM_Timing_Init(FSMC_Bank1,&readWriteTiming ,FSMC_NORSRAM_BANK1);
    FSMC_NORSRAM_Extended_Timing_Init(FSMC_Bank1E, &writeTiming, FSMC_NORSRAM_BANK1,    FSMC_EXTENDED_MODE_ENABLE);
    FSMC_NORSRAM_WriteOperation_Enable(FSMC_Bank1, FSMC_NORSRAM_BANK1);
